  ...
  document.addEventListener('DOMContentLoaded', function() {
      document.getElementById('wf-form-reference-code').addEventListener('submit', function(event) {
          ...
          .then(response => {
              ...
              document.querySelector('.success-message_wrapper').style.display = "block"
              return response.json();
          })
          .catch(error => {
              document.getElementById('error-reference').innerText = 'There has been a problem with your fetch operation';
              document.querySelector('.error-message_wrapper').style.display = "block"
